        ...
        with (open(file_path, 'r') as file):
            ...
            for lent, css, ques, ans, asses in itertools.zip_longest(*[file] * 5):
                ...
                for j in range(steps):
                    ...
                    correspond_rawid=idx2rawid[Config.ASSIGNMENT_ID][quesid0_9]
                    ...
                    # AC rate
                    temp[j + extra][
                    KCA_config.for_readdata - KCA_config.KC_one_hot_dim - KCA_config.score_encoding
                    :KCA_config.for_readdata - KCA_config.KC_one_hot_dim] = raw_score

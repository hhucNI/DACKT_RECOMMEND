        ...
        with (open(file_path, 'r') as file):
            ...
            for lent, css, ques, ans, asses in itertools.zip_longest(*[file] * 5):
                ...
                temp = np.zeros(shape=[self.maxstep,
                                       QP2KT_config.for_readdata])  # Skill DKT #1, original
                ...
                for j in range(steps):
                    ...
                    # 增加问题特征
                    temp[j + extra][
                    QP2KT_config.code2vec_dim + QP2KT_config.ques_encoding
                    :QP2KT_config.code2vec_dim + QP2KT_config.d_bert
                     + QP2KT_config.ques_encoding]= self.bert_questions[bert_ques_idx].cpu().numpy()
                    ...
                    # 添加知识点 KC
                    watch_var=temp[j + extra][QP2KT_config.for_readdata - QP2KT_config.KC_one_hot_dim:]
                    temp[j + extra][QP2KT_config.for_readdata - QP2KT_config.KC_one_hot_dim:][kc_list_cur_ques] = 1
                    ...
                    time_feature=[time_diff*QP2KT_config.time_encoding]
                    temp[j + extra][QP2KT_config.code2vec_dim + QP2KT_config.d_bert + QP2KT_config.ques_encoding:
                    QP2KT_config.for_readdata-QP2KT_config.score_encoding-QP2KT_config.KC_one_hot_dim]=time_diff
                    ...
                    #     fill_time_in(t,
                    #                  QP2KT_config.code2vec_dim + QP2KT_config.d_bert + QP2KT_config.ques_encoding + i * 2,
                    #                  temp[j + extra])

                    # AC rate
                    raw_score_dup=[raw_score*QP2KT_config.score_encoding]
                    temp[j + extra][
                    QP2KT_config.for_readdata - QP2KT_config.score_encoding-QP2KT_config.KC_one_hot_dim:
                    QP2KT_config.for_readdata - QP2KT_config.KC_one_hot_dim] = raw_score_dup
                    ...
                    if type(code) == str:
                        ...
                        temp[j + extra][QP2KT_config.ques_encoding
                                        :QP2KT_config.ques_encoding + QP2KT_config.code2vec_dim] = features
